...
ALTER TABLE registro ADD COLUMN imagen_perfil VARCHAR(255) DEFAULT 'default.png';
ALTER TABLE registro ADD COLUMN fecha_registro TIMESTAMP DEFAULT CURRENT_TIMESTAMP;